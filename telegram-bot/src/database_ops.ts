...
export const FIELD_LABELS: Record<string, string> = {
    ...
    iess_password:                'Clave IESS',
    clave_iess:                   'Clave IESS',
    claveIess:                    'Clave IESS',
    iess:                         'Clave IESS',
    electronicSignaturePassword:  'Clave Firma Electrónica',
    electronic_signature_password: 'Clave Firma Electrónica',
    signature_password:           'Clave Firma Electrónica',
    signaturePassword:            'Clave Firma Electrónica',
    clave_firma:                  'Clave Firma Electrónica',
    claveFirma:                   'Clave Firma Electrónica',
    firma:                        'Clave Firma Electrónica',
    signatureExpirationDate:      'Caducidad Firma',
    signature_expiration:         'Caducidad Firma',
    signatureExpiration:          'Caducidad Firma',
    caducidad_firma:              'Caducidad Firma',
    caducidadFirma:               'Caducidad Firma',
    notes:                        'Notas',
    notas:                        'Notas',
    ...
    shared_access_key:            'Clave Compartida',
    billing_system:               'Sistema de Facturación',
    facturador:                   'Sistema de Facturación',
    sistema_facturacion:          'Sistema de Facturación',
    sistemaFacturacion:           'Sistema de Facturación',
    billing_user:                 'Usuario de Facturación',
    usuario_facturador:           'Usuario de Facturación',
    usuarioFacturador:            'Usuario de Facturación',
    billing_password:             'Clave de Facturación',
    clave_facturador:             'Clave de Facturación',
    claveFacturador:              'Clave de Facturación',
    contrasena_facturador:        'Clave de Facturación',
    billing_price:                'Precio del Facturador',
    precio_facturador:            'Precio del Facturador',
    precioFacturador:             'Precio del Facturador',
    costo_facturador:             'Precio del Facturador',
    billing_expiration:           'Vencimiento del Facturador',
...
export const FIELD_DB_MAPPING: Record<string, string> = {
    ...
    clave:                        'sri_password',
    clave_sri:                    'sri_password',
    claveSri:                     'sri_password',
    email:                        'email',
    correo:                       'email',
    phones:                       'phones',
    telefono:                     'phones',
    ...
    nombreComercial:              'trade_name',
    iessPassword:                 'iess_password',
    iess_password:                'iess_password',
    clave_iess:                   'iess_password',
    claveIess:                    'iess_password',
    iess:                         'iess_password',
    electronicSignaturePassword:  'signature_password',
    electronic_signature_password: 'signature_password',
    signature_password:           'signature_password',
    signaturePassword:            'signature_password',
    clave_firma:                  'signature_password',
    claveFirma:                   'signature_password',
    firma:                        'signature_password',
    ...
    expiration_date:              'signature_expiration',
    caducidad_firma:              'signature_expiration',
    caducidadFirma:               'signature_expiration',
    notes:                        'notes',
    notas:                        'notes',
    ...
    facturador:                   'billing_system',
    sistema_facturacion:          'billing_system',
    sistemaFacturacion:           'billing_system',
    billing_user:                 'billing_user',
    usuario_facturador:           'billing_user',
    usuarioFacturador:            'billing_user',
    billing_password:             'billing_password',
    clave_facturador:             'billing_password',
    claveFacturador:              'billing_password',
    contrasena_facturador:        'billing_password',
    billing_price:                'billing_price',
    precio_facturador:            'billing_price',
    precioFacturador:             'billing_price',
    costo_facturador:             'billing_price',
    billing_expiration:           'billing_expiration',
    vigencia_facturador:          'billing_expiration',
    vigenciaFacturador:           'billing_expiration',
    caducidad_facturador:         'billing_expiration',
};
