                           ...
                           <div className="mb-4 pb-2 border-b border-gray-300 dark:border-gray-600 space-y-1">
                            ...
                            <h4 className="font-bold text-lg text-center mb-2">Detalle de Pago</h4>
                             <table className="w-full text-left">
                                 ...
                                 <tfoot>
                                    <tr className="font-bold border-t-2 border-gray-300 dark:border-gray-600"><td className="py-2 pt-4 text-right">Total Pagado</td><td className="py-2 pt-4 text-right">${receiptData.totalAmount.toFixed(