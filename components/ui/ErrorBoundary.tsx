    ...
    if (hasError) {
      ...
      return (
        <div className="flex flex-col items-center justify-center h-full min-h-[60vh] p-8 text-center animate-fade-in-up bg-slate-50 dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 m-4 shadow-sm">
          ...
          <h2 className="text-3xl font-display font-medium text-slate-800 dark:text-white mb-3">
          ...
          <div className="w-full max-w-lg bg-white dark:bg-slate-900 rounded-xl border border-red-100 dark:border-red-900/30 p-4 mb-8 text-left shadow-sm overflow-hidden">
             <div className="flex items-center gap-2 mb-2 text-xs font-medium text-rose-400 uppercase tracking-wider">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
              <button 
                onClick={this.handleReload}
                className="flex items-center justify-center space-x-3 px-8 py-4 bg-[#0B2149] hover:bg-slate-800 text-white font-medium rounded-2xl shadow-xl shadow-slate-900/10 transition-all transform hover:scale-105 active:scale-95 group"
              >
