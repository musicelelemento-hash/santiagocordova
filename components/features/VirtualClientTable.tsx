                ...
                <div className="flex items-center gap-3 mt-1.5">
                    ...
                    {(() => {
                        ...
                        return statusInfo.isUpdated ? (
                            <span title={statusInfo.tooltip} className="flex items-center gap-1 text-[9px] px-2 py-0.5 rounded-full bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 font-bold border border-emerald-500/30 uppercase tracking-wider shrink-0 shadow-sm">
                                <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 shrink-0" style={{boxShadow:'0 0 6px rgba(16,185,129,0.8)'}} />
                                <span>{statusInfo.label}</span>
                            </span>
                        ) : (
                            <span title={statusInfo.tooltip} className="flex items-center gap-1 text-[9px] px-2 py-0.5 rounded-full bg-amber-500/10 text-amber-600 dark:text-amber-400 font-bold border border-amber-500/30 uppercase tracking-wider shrink-0">
