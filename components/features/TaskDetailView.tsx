        ...
        <div className="p-4 bg-white dark:bg-gray-900 rounded-lg animate-slide-up-fade relative" style={{ opacity: 0 }}>
            ...
            {(task as any).isAutoGenerated && (
                <div className="p-4 mb-6 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-2xl flex items-center justify-between">
                    <div>
                        <p className="text-amber-900 dark:text-amber-100 font-black text-sm uppercase tracking-tight">Órden de Trabajo Táctica</p>
                    ...
                    {task.clientId && (
                        <button
                            className="px-4 py-2 bg-amber-500 text-white text-[10px] font-black uppercase tracking-widest rounded-xl shadow-lg shadow-amber-500/20"
                            onClick={() => {
            ...
            <div className="space-y-4">
                ...
                {(task as any).isAutoGenerated && (
                    <div className="p-4 bg-slate-50 dark:bg-slate-800 rounded-2xl mt-4">
                        <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest block mb-2">Paso Siguiente</label>
