        ...
        <div className="space-y-8 animate-fade-in relative px-1">
            ...
            <div
                ...
                className={`
                    ...
                    ${isAnalyzing 
                        ? 'border-emerald-400 bg-emerald-400/10 shadow-[0_0_30px_rgba(16,185,129,0.2)]' 
                        : 'glass-elite border-white/20 hover:border-emerald-400/50 hover:shadow-[0_0_20px_rgba(16,185,129,0.1)]'}
                `}
            >
                <div className="absolute inset-0 bg-gradient-to-r from-emerald-400/5 to-sky-400/5 opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
                ...
                {isAnalyzing ? (
                    <div className="flex flex-col items-center justify-center gap-4 py-2">
                        <div className="relative">
                            ...
                            <Loader className="w-10 h-10 text-emerald-400 animate-spin relative z-10" />
                        </div>
                        <div className="space-y-1">
                            <p className="text-sm font-semibold text-emerald-400 uppercase tracking-[0.2em] animate-pulse">Analizando Núcleo SRI</p>
                            <p className="text-[10px] text-slate-400 font-medium uppercase tracking-widest">Extrayendo ADN Tributario...</p>
                        </div>
                    </div>
                ) : (
                    <div className="flex flex-col items-center justify-center gap-4 py-2">
                        <div className="bg-emerald-400/10 p-4 rounded-2xl text-emerald-400 group-hover:scale-110 transition-transform duration-500 shadow-inner">
                            <ScanLine size={32} strokeWidth={2.5} />
                        </div>
                        <div>
                            <h4 className="text-md font-semibold dark:text-white text-slate-800 uppercase tracking-widest mb-1">
                                <span className="text-gradient-teal">Stitch Scanner</span> Elite
                            </h4>
                            <p className="text-[10px] font-medium text-slate-400 uppercase tracking-widest opacity-80">Arrastra o haz clic para procesar Certificado RUC (PDF)</p>
                        </div>
                    </div>
                )}
            </div>
            {clientData.rucCertificate && (
                <div className="flex items-center gap-2 p-3 bg-teal-50 dark:bg-teal-900/20 border border-teal-100 dark:border-teal-800 rounded-2xl animate-fade-in shadow-sm">
                    ...
                    <div className="flex-1 overflow-hidden">
                        <p className="text-[10px] font-semibold text-brand-teal uppercase tracking-widest leading-tight">Certificado RUC detectado</p>
                    ...
                    <div className="flex items-center gap-1.5 px-3 py-1.5 bg-brand-teal text-white rounded-xl text-[10px] font-semibold uppercase tracking-widest shadow-lg shadow-teal-500/20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="space-y-6 glass-elite p-6 rounded-[2rem] border border-white/10">
                    <div className="flex items-center gap-3 pb-4 border-b border-white/5">
                        <div className="bg-sky-400/10 p-2 rounded-xl text-sky-400">
                            <User size={20} />
                        </div>
                        <h3 className="text-[11px] font-semibold text-slate-400 uppercase tracking-[0.2em]">Identidad y Contacto <span className="text-emerald-400 ml-1">Elite</span></h3>
                    </div>

                    <div className="space-y-4">
                        <div className="relative">
                            <label className="text-[9px] font-semibold text-slate-400 mb-2 block uppercase tracking-widest pl-1">RUC Contribuyente</label>
                            <div className="relative group">
                                <CreditCard className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-emerald-400 transition-colors" size={18} />
                                <input
                                    type="text"
                                    ...
                                    className={`w-full pl-12 p-3.5 bg-white/5 dark:bg-slate-900/40 border rounded-2xl text-sm font-mono font-semibold outline-none focus:ring-2 focus:ring-emerald-400/30 transition-all backdrop-blur-3xl ${validationErrors.ruc ? 'border-rose-400/50' : 'border-white/10 dark:border-white/5'}`}
                        ...
                        <div className="relative">
                            <label className="text-[9px] font-semibold text-slate-400 mb-2 block uppercase tracking-widest pl-1">Razón Social</label>
                            <div className="relative group">
                                <Building2 className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-emerald-400 transition-colors" size={18} />
                                <input
                                    type="text"
                                    value={clientData.name || ''}
                                    onChange={e => setClientData({ ...clientData, name: e.target.value })}
                                    className="w-full pl-12 p-3.5 bg-white/5 dark:bg-slate-900/40 border border-white/10 dark:border-white/5 rounded-2xl text-sm font-semibold outline-none focus:ring-2 focus:ring-sky-400/30 transition-all backdrop-blur-3xl"
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <label className="text-[9px] font-semibold text-slate-400 mb-2 block uppercase tracking-widest pl-1">WhatsApp</label>
                                <div className="relative group">
                            ...
                            <div>
                                <label className="text-[9px] font-semibold text-slate-400 mb-2 block uppercase tracking-widest pl-1">Email</label>
                                <div className="relative group">
                        ...
                        <div className="relative">
                            <label className="text-[10px] font-medium text-slate-500 mb-1 block uppercase tracking-wider">Dirección (Ubicación)</label>
                            <div className="relative">
                ...
                <div className="space-y-6 glass-elite p-6 rounded-[2rem] border border-white/10">
                    <div className="flex items-center gap-3 pb-4 border-b border-white/5">
                        <div className="bg-emerald-400/10 p-2 rounded-xl text-emerald-400">
                            <Briefcase size={20} />
                        </div>
                        <h3 className="text-[11px] font-semibold text-slate-400 uppercase tracking-[0.2em]">Configuración <span className="text-gradient-teal">Tributaria</span></h3>
                    </div>

                    <div className="space-y-5">
                        <div className="mb-2">
                            <label className="text-[9px] font-semibold text-slate-400 mb-3 block uppercase tracking-widest pl-1">Régimen Estratégico</label>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="relative">
                                <label className="text-[10px] font-medium text-slate-500 mb-1 block uppercase tracking-wider">Clave SRI</label>
                                <div className="relative">
                            ...
                            <div className="relative">
                                <label className="text-[10px] font-medium text-slate-500 mb-1 block uppercase tracking-wider">Vence Firma Elec.</label>
                                <div className="relative">
                            ...
                            <div className="grid grid-cols-3 gap-2">
                                {[
                                    ...
                                    <button
                                         ...
                                         className={`p-2.5 rounded-xl text-[10px] font-medium border transition-all ${ivaFrequency === opt.id || (clientData.regime === TaxRegime.RimpeEmprendedor && opt.id === 'Semestral') || (clientData.regime === TaxRegime.RimpeNegocioPopular && opt.id === 'Ninguno') ? 'bg-blue-50 border-sky-400 text-blue-700 shadow-sm' : 'bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 text-slate-500'} ${(clientData.regime === TaxRegime.RimpeEmprendedor && opt.id !== 'Semestral') || (clientData.regime === TaxRegime.RimpeNegocioPopular && opt.id !== 'Ninguno') ? 'opacity-50 cursor-not-allowed' : ''}`}
                                     >
                                         {opt.label}
                                     </button>
                                ))}
                                    ...
                                    <label key={mod.id} className={`flex items-center p-4 rounded-2xl border transition-all duration-300 ${mod.disabled ? 'opacity-70 cursor-not-allowed bg-slate-100/10' : 'cursor-pointer'} ${mod.checked ? `border-${mod.color}-500/50 bg-${mod.color}-500/5 shadow-[0_0_15px_rgba(0,0,0,0.05)] scale-[1.02]` : 'border-white/10 hover:border-white/20'}`}>
                                        ...
                                        <div className="flex-1">
                                            <div className="flex justify-between items-center mb-0.5">
                                                ...
                                                {(mod as any).alert && <span className="text-[8px] font-semibold uppercase bg-amber-400/10 text-amber-400 px-2 py-0.5 rounded-full border border-amber-400/20">{(mod as any).alert}</span>}
                                            </div>
                                            <div className="flex items-center gap-2 opacity-50">
                                                <mod.icon size={10} />
                                                <span className="text-[9px] font-medium uppercase tracking-widest">{mod.sub}</span>
                                            </div>
                                        </div>
                                    </label>
                                ))}
                        ...
                        <div className="bg-slate-950/5 dark:bg-white/5 rounded-3xl p-5 border border-white/10 shadow-inner backdrop-blur-3xl">
                            <div className="flex flex-col gap-4">
                                <div className="flex justify-between items-center gap-4">
                                    <div onClick={() => setIsVip(!true)} className={`flex items-center gap-3 p-3 rounded-2xl border transition-all cursor-pointer flex-1 ${true ? 'bg-amber-400/10 border-amber-400/30' : 'bg-white/5 border-white/10 opacity-50'}`}>
                                        ...
                                        <div className="flex flex-col">
                                            <span className="text-[9px] font-semibold text-slate-400 uppercase tracking-widest">Socio VIP</span>
                                            <span className={`text-[10px] font-semibold ${true ? 'text-amber-400' : 'text-slate-400'}`}>{true ? 'ELITE' : 'NORMAL'}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div onClick={() => setIsActive(!isActive)} className={`flex items-center gap-3 p-3 rounded-2xl border transition-all cursor-pointer flex-1 ${isActive ? 'bg-emerald-400/10 border-emerald-400/30' : 'bg-white/5 border-white/10 opacity-50'}`}>
                                        ...
                                        <div className="flex flex-col">
                                            <span className="text-[9px] font-semibold text-slate-400 uppercase tracking-widest">Estado</span>
                                            <span className={`text-[10px] font-semibold ${isActive ? 'text-emerald-400' : 'text-slate-400'}`}>{isActive ? 'ACTIVO' : 'PAUSADO'}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="relative group">
                                        <label className="text-[9px] font-semibold text-slate-400 mb-2 block uppercase tracking-widest pl-1">Cuota Periódica</label>
                                        <div className="relative">
                                    ...
                                    <div className="relative group">
                                        <label className="text-[9px] font-semibold text-slate-400 mb-2 block uppercase tracking-widest pl-1">Cuota Anual</label>
                                        <div className="relative">
                                            <DollarSign className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-emerald-400" size={14} />
            ...
            <div className="flex gap-4 pt-4 border-t border-white/10">
                <button onClick={onCancel} className="flex-1 py-4 bg-white/5 text-slate-400 font-semibold rounded-2xl hover:bg-white/10 transition-all uppercase text-[10px] tracking-widest border border-white/5">
                    Abortar Operación
                </button>
                <button onClick={handleSubmit} className="flex-[2] py-4 bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-semibold rounded-2xl shadow-2xl transition-all transform hover:scale-[1.02] active:scale-95 flex items-center justify-center gap-3 text-[10px] uppercase tracking-[0.2em]">
                    <Save size={20} />
