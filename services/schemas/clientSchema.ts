...
export const DeclarationSchema = z.object({
    ...
    proofFile: StoredFileSchema.optional(),
});
...
export const ClientSchema = z.object({
    ...
    declarationHistory: z.array(DeclarationSchema),
    isDeleted: z.boolean().optional(),
    isActive: z.boolean().optional(),
    taxProfile: TaxProfileSchema.optional(),
    customServiceFee: z.number().optional(),
    feeStructure: ClientFeeStructureSchema.optional(),
    annualRentaStatus: z.nativeEnum(DeclarationStatus).optional(),
    annualRentaPaid: z.boolean().optional(),
    annualRentaProof: StoredFileSchema.optional(),
    anexoGastosStatus: z.nativeEnum(DeclarationStatus).optional(),
    anexoGastosPaid: z.boolean().optional(),
    anexoGastosProof: StoredFileSchema.optional(),
    devolucionIvaStatus: z.nativeEnum(DeclarationStatus).optional(),
    devolucionIvaPaid: z.boolean().optional(),
    devolucionIvaProof: StoredFileSchema.optional(),
    iceAnexoStatus: z.nativeEnum(DeclarationStatus).optional(),
    iceAnexoPaid: z.boolean().optional(),
    iceAnexoProof: StoredFileSchema.optional(),
    iceDeclarationStatus: z.nativeEnum(DeclarationStatus).optional(),
    iceDeclarationPaid: z.boolean().optional(),
    iceDeclarationProof: StoredFileSchema.optional(),
    anexoPvpStatus: z.nativeEnum(DeclarationStatus).optional(),
    anexoPvpPaid: z.boolean().optional(),
    anexoPvpProof: StoredFileSchema.optional(),
