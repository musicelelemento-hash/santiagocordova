...
import { ArrowRight, UserCheck, Users, Calendar, Clock as ClockIcon, FileText, Receipt, UserPlus, Gift, TrendingUp } from 'lucide-react';
...
export const HomeScreen: React.FC<HomeScreenProps> = ({ navigate, serviceFees, clients, tasks }) => {
    const allMenuItems = useMemo(() => {
        const menuItems: MenuItem[] = [
          ...
          // Nuevo botón destacado para la temporada
          {
            title: 'Vender Combo Renta',
            description: 'Pack $25: Declaración + Anexo + Devolución.',
            icon: Gift,
            highlight: true,
            navigation: {
                screen: 'tasks',
