                    ...
                    <div className="p-8 relative z-10">
                        ...
                        <div className="grid grid-cols-2 gap-2 bg-black/20 p-1.5 rounded-2xl mb-8 border border-white/5">
                            <button 
                                ...
                                className={`py-3 text-xs font-black uppercase tracking-wider rounded-xl transition-all duration-300 flex items-center justify-center gap-2 ${loginType === 'client' ? 'bg-[#00A896] text-white shadow-lg shadow-teal-900/50' : 'text-slate-500 hover:text-white hover:bg-white/5'}`}
                            >
                                <Briefcase size={14}/> Clientes
                            </button>
                            <button 
                                onClick={() => { setLoginType('admin'); setError(''); }}
                                className={`py-3 text-xs font-black uppercase tracking-wider rounded-xl transition-all duration-300 flex items-center justify-center gap-2 ${loginType === 'admin' ? 'bg-white text-[#0B2149] shadow-lg' : 'text-slate-500 hover:text-white hover:bg-white/5'}`}
                            >
                                <Lock size={14}/> Admin
                            </button>
                        </div>
                        ...
                        <form onSubmit={handleLogin} className="space-y-6">
                            <div className="space-y-2">
                                <label className="text-[11px] font-black text-[#00A896] uppercase tracking-[0.2em] ml-2">
